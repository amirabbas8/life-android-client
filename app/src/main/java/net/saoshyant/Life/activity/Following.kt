...
class Following : AppCompatActivity() {
        ...
        refreshLayout!!.onRefreshListener = object : RefreshLayout.OnRefreshListener {
            ...
            override fun onLoadMore() {
                if (9 < peopleList.size) {
                    getPeopleData("followingLoadMore")
    ...
    private fun getPeopleData(tag: String) {
        ...
        params["id"] = id!!
        params["pid"] = lastId
        val strReq = object : StringRequest(Request.Method.POST, "http://saoshyant.net/Life/getFollowingData.php", Response.Listener { response ->
