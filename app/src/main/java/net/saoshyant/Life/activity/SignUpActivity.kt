...
class SignUpActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        usernameText = findViewById(R.id.input_username) as EditText
        mobileText = findViewById(R.id.input_mobile) as EditText
        passwordText = findViewById(R.id.input_password) as EditText
        signUpButton = findViewById(R.id.btn_signup) as Button
        val loginLink = findViewById(R.id.link_login) as TextView
    ...
    private fun ProcessLogin() {
        ...
        val code = (Random().nextInt(999999 - 100000 + 1) + 100000).toString()
...
//        InstanceID.getInstance(applicationContext).id
        ...
        val strReq = object : StringRequest(Request.Method.POST, "http://saoshyant.net/Life/signUp.php", Response.Listener { response ->
