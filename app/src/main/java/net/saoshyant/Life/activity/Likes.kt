...
class Likes : AppCompatActivity() {
    ...
    private fun getPeopleData(tag: String) {
        ...
        params["id"] = id!!
        params["pid"] = lastId
        val strReq = object : StringRequest(Request.Method.POST, "http://saoshyant.net/Life/getLikeData.php", Response.Listener { response ->
